...
class UIView_ExtensionsTests: XCTestCase {
    ...
    func test_UIView_Rotated() {
        ...
        view.rotated(duration: 0.3, angle: -60).perform()
    ...
    func test_UIView_Scaled() {
        ...
        view.scaled(duration: 0.3, x: 1.3, y: 1.3).perform()
    ...
    func test_UIView_Translated() {
        ...
        view.translated(duration: 0.3, x: 10, y: 10).perform()
    ...
    func test_UIView_Corner() {
        ...
        view.cornerRadius(5, duration: 0.3).perform()
